export default function AuthLayout({ 
  ...
  return (
    <div className={`auth-layout bg-gradient-to-br ${variants[variant]}`}>
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className={`absolute top-0 right-0 w-96 h-96 ${decorations[variant].top} rounded-full blur-3xl`} />
